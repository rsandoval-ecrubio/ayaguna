...
$query_invtp40 = "SELECT contenedor, tipo, estatus, condicion, eirR, descarga, recepcion,ubicacion, obs, linea, buque, viaje, DIC, DIY FROM consulta_x_consignatario WHERE consig_id = $linea AND c = 0 AND tipo LIKE '4%' ORDER BY descarga ASC";
...
// Kaosweaver Live Clock End
 ...
 <div id="nav">
  ...
  <div id="content">
   &nbsp;
   <h2>EQUIPOS DE 40'</h2>
   <p><a href="exportar_invt40.php">Exportar a Excel</a></p>
