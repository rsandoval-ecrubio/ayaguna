...
$query_invdmg = "SELECT contenedor, tipo, estatus, condicion, eirR, descarga, recepcion,ubicacion, obs, linea, buque, viaje, DIC, DIY  FROM consulta_x_consignatario WHERE consig_id = $linea AND c = 0 AND condicion = 'DMG' ORDER BY descarga ASC";
...
// Kaosweaver Live Clock End
 ...
 <div id="nav">
  ...
  <div id="content">
    <h2>EQUIPOS DAÑADOS (DMG)</h2>
    <p><a href="exportar_invdmg.php">Exportar a Excel</a></p>
