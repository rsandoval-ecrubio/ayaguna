...
//Fecha de recepcion en patio MENFEL
$frd = $_POST['frd'];
...
$sqltxt_eq = "INSERT INTO inventario (acta, linea, buque, viaje, tcont, contenedor, fdb, fdm, frd, eir_r, rep_dano, `status`, condicion, precinto, bl, patio, consignatario, obs, auditoria, codigo_b_actas) VALUES ('$id_acta','$linea','$buque','$viaje','$tipo','$equipo','$viajeDate','$fdm','$frd','$eir','$rep_dano','$estatus','$condicion','$precinto','$bl','$ubicacion','$consignatario', '$obs','$auditoria','$cod_gen1')";
