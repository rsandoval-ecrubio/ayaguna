...
<body>
<h2>INVENTARIO 40&quot; POR LINEA: <?php echo $row_inv['nlinea']; ?> - <?php echo ALMACEN;?></h2>
  ...
  <tbody>
    <?php do { ?>
      <tr>
        ...
        <td align="center"><?php status($row_inv['status']); ?></td>
        ...
        <td class="rightAlign"><?php alarmapais($row_inv['dpais']); ?>
          &nbsp;</td>
